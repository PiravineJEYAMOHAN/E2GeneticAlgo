...
def create_gray_pattern(filename):
    dwg = svgwrite.Drawing(filename, size=(DIM, DIM))
    # Ajouter un rectangle gris qui couvre toute la surface
    dwg.add(dwg.rect((0, 0), (DIM, DIM), fill='gray'))
...
create_gray_pattern('pattern0.svg')